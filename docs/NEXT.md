...
| feature-paperclip-first-architecture | In flight (Phases 0-3 + Phase-5 render + SKILL stub shipped & Codex-reviewed; paperclip-mode path smoke-PASSED locally 2026-06-28; remaining: PDF-mode/full-fixture smoke, gated on GROBID/Docker) | No | `feat/paperclip-first-smoke-gate` |
