...
| feature-paperclip-first-architecture | In flight (Phases 0-2 + Phase-3 `8d2019b`/`0f25bd2` + Phase-5 render shipped, Codex-reviewed 2026-06-27; remaining: SKILL refresh + end-to-end smoke, both need live paperclip CLI) | No | `feat/paperclip-first-smoke-gate` |
