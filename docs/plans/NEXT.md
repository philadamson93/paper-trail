...
- **Isolation plan — CONTAINERS-FIRST decided; four-repo prior-work sweep DONE 2026-09-12.**
  [`isolation-protocol.md`](isolation-protocol.md) `Status: APPROVED 2026-09-15` `Reviewed: Yes` (plan-sha `942a5f0c9948`) · six review passes, **all 12 questions resolved** · scope: **adjudicator dispatch only**.
  ⚠ **Two blockers before coding:** rebase onto Plan A’s tip `f02d761`; then sweep ~120 stale uses of "judge" — it changes whether a reader builds one mount set or three.
