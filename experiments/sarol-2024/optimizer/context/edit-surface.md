...
And the four manifest entries that are **frozen contract files** — in the program, never editable,
...
| `experiments/sarol-2024/specs/verdict_definitions_sarol.md` | the paper's Table 1 definitions, verbatim |
...
One of those four needs a word more, because it is frozen *and* judge-inert, which is an unusual
pair:

- `experiments/sarol-2024/specs/verdict_definitions_sarol.md` — what each label *means*, from Sarol
  et al. 2024 Table 1. **It is a frozen manifest entry, and the judge never loads it.** It is a
